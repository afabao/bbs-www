<template>
  <div>
    <div>
      ...
      <el-button type="primary" size="small" style="margin-top: 5px;margin-left: 5px" @click="searchResource">查询</el-button>
      <el-button type="primary" size="small" style="margin-top: 5px;margin-left: 5px" @click="addResource()">新增</el-button>
      <el-button type="primary" size="small" style="margin-top: 5px;margin-left: 5px" @click="editResource()">修改</el-button>
    </div>
